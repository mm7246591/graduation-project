    ...
    <div class="w-full bg-[#F5F5F5] text-[#2A3752]">
        ...
        <div
            ...
            <div class="w-[90vw] flex flex-col justify-center items-center py-[4vh] mx-auto">
                <div class="sm:flex lg:hidden my-[2vh] text-center text-sm">
                    今年共有22組作品共同參與畢業展，<br>其包含了4組影視短片、1組行銷企劃、<br>11組互動裝置、4組遊戲開發及2組專題研究組成。
                </div>
                <div class="lg:flex sm:hidden my-[2vh] text-center text-xl ">
                ...
                <div class="w-[90vw] flex sm:flex-col justify-evenly items-center">
                    <div v-for="group of groups" :key="group.id"
                        ...
                        <div class="w-full sm:h-[15vh] sm:px-[2vw] text-center text-sm whitespace-pre-line">
                            {{ group.text }}
                        </div>
                    </div>
                </div>
